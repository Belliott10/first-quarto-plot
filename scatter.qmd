...
format:
  pdf:
    ...
    fontsize: 12pt
    geometry: margin=1in
    linestretch: 1.9          # double spacing
    pdf-engine: xelatex
    keep-tex: true
...
header-includes: |
  ...
  % -------------------------
  \titleformat{\section}
    {\centering\Large\bfseries}  % centered, bold, larger
    {\thesection}{1em}{}

  \titleformat{\subsection}
    {\centering\large\bfseries}  % centered, bold, slightly smaller
    {\thesubsection}{1em}{}

  % -------------------------
  % Reduce Vertical Spacing
  % -------------------------
  % Arguments: {left}{before}{after}
  \titlespacing{\section}{0pt}{0.8em}{0.5em}       % section: before, after
  \titlespacing{\subsection}{0pt}{0.5em}{0.3em}    % subsection: before, after

  % -------------------------
  % Paragraph Formatting
  % -------------------------
  \setlength{\parindent}{0pt}  % no paragraph indentation
  % We do NOT use \usepackage{parskip} to avoid extra vertical spacing
---
