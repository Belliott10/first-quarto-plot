...
## Identification
The key assumption is that, absent Katrina, New Orleans employment would have evolved similarly to the synthetic control.The MSCc parallel trends assumption holds if the difference between the observed and predicted in the pre-treatment period is a zero mean stationary process. Additionally, we assume SUTVA (given that we drop similarly affected units) and zero anticipation. 
