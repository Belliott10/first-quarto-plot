...
*Note: Gap between actual New Orleans employment growth and synthetic control from 1990 through 2009. The vertical line marks the treatment (Hurricane Katrina, Aug 2005). Post-treatment divergence reflects the estimated effect and subsequent recovery. This figure emphasizes the overall magnitude and trend of the treatment effect.*
...
plt.show()
```
*Note: Gap between actual and synthetic control during the pre-treatment period (1990–2005). The gap fluctuates tightly around zero, validating the identification assumption and the quality of the synthetic control fit. This figure highlights the small pre-treatment fluctuations that are less visible in the main figure.*
